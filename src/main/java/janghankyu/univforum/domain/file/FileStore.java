...
public class FileStore {
    ...
    @Value("/Users/hankyujang/Desktop/upload/univForum")
    ...
    private Attachment storeFile(MultipartFile multipartFile, AttachmentType attachmentType) throws IOException {
        if(multipartFile.isEmpty()){
            return null;
        }
